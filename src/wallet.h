...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 OX1 at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zOX1 send
enum ZerocoinSpendStatus {
    ZOX1_SPEND_OKAY = 0,                            // No error
    ZOX1_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZOX1_WALLET_LOCKED = 2,                         // Wallet was locked
    ZOX1_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZOX1_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZOX1_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZOX1_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZOX1_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZOX1_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZOX1_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZOX1_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZOX1_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZOX1_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZOX1_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZOX1_SPENT_USED_ZOX1 = 14,                      // Coin has already been spend
    ZOX1_TX_TOO_LARGE = 15                          // The transaction is larger than the max tx size
};
...
public:
    ...
    */
    ...
    void setZOx1AutoBackups(bool fEnabled)
    {
