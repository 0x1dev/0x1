...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::OX1, nValue);
...
{
    std::string genesisblockhash = "00000897f7f2c1f7e1a8ae77b980bc2bf8d3ba902f3dbbc5f882accab7253ec2";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (ox1.conf).");
            QMessageBox::warning(this, "OX1 Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#505050;}\n a, span { font-family: monospace; }\n span.addr {color:#505050; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #505050;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#505050;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#505050;}\n";
