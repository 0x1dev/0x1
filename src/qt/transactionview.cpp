                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Ox1 from zOx1"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zOx1"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zOx1));
