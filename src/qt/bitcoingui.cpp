                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OX1 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OX1 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ox1: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOX1"));
    ...
    fileSharingAction = new QAction(QIcon(":/icons/filesharing"), tr("&File Sharing"), this);
    fileSharingAction->setStatusTip(tr("File Sharing"));
    fileSharingAction->setToolTip(fileSharingAction->statusTip());
    fileSharingAction->setCheckable(true);
#ifdef Q_OS_MAC
    fileSharingAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_7));
#else
    fileSharingAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_7));
#endif
    ...
    connect(fileSharingAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OX1 Core"), this);
    aboutAction->setStatusTip(tr("Show information about OX1 Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OX1"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OX1 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OX1 addresses"));
    ...
    openAction->setStatusTip(tr("Open a OX1: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OX1 Core help message to get a list with possible OX1 command-line options"));
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    fileSharingAction->setEnabled(false);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OX1 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::createTrayIconMenu()
{
    ...
    //trayIconMenu->addAction(fileSharingAction);
    trayIconMenu->addSeparator();
...
void BitcoinGUI::gotoFileSharingPage()
{
    ...
    if (walletFrame) walletFrame->gotoFileSharingPage();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OX1 network", "", count));
}
...
{
    QString strTitle = tr("OX1 Core"); // default title
