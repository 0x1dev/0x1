...
#include "filesharing/filesharingdialog.h"
                                          ...
                                          walletModel(0)
{
    ...
    fileSharingPage = new FileSharingDialog();
...
void WalletView::setWalletModel(WalletModel* walletModel)
{
    ...
    fileSharingPage->setModel(walletModel);
...
void WalletView::gotoFileSharingPage()
{
    setCurrentWidget(fileSharingPage);
}
