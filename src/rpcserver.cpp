...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ox1 features */
        {"ox1", "masternode", &masternode, true, true, false},
        {"ox1", "listmasternodes", &listmasternodes, true, true, false},
        {"ox1", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ox1", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ox1", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ox1", "masternodedebug", &masternodedebug, true, true, false},
        {"ox1", "startmasternode", &startmasternode, true, true, false},
        {"ox1", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ox1", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ox1", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ox1", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ox1", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ox1", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ox1", "mnbudget", &mnbudget, true, true, false},
        {"ox1", "preparebudget", &preparebudget, true, true, false},
        {"ox1", "submitbudget", &submitbudget, true, true, false},
        {"ox1", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ox1", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ox1", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ox1", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ox1", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ox1", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ox1", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ox1", "checkbudgets", &checkbudgets, true, true, false},
        {"ox1", "mnsync", &mnsync, true, true, false},
        {"ox1", "spork", &spork, true, true, false},
        {"ox1", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ox1", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ox1d, or the -server option to ox1-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ox1-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10111/\n";
}
