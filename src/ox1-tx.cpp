...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ox1 Core ox1-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ox1-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ox1 transaction") + "\n" +
                               "  ox1-tx [options] -create [commands]   " + _("Create hex-encoded ox1 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ox1 transaction
