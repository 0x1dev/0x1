...
#   c) node1 mines 32 blocks, so now node 0 has 60001Ox1, node 1 has 4250Ox1, node2 has none.
#   d) node0 sends 601 Ox1 to node2, in two transactions (301 Ox1, then 300 Ox1).
