...
This mechanism has been integrated into Bitcore-Node-OX1 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/0x1project/insight-api-ox1#web-socket-api](https://github.com/0x1project/insight-api-ox1#web-socket-api) 
* API: [https://github.com/0x1project/insight-api-ox1#swifttx-transactions](https://github.com/0x1project/insight-api-ox1#swifttx-transactions) 
...
By default, the OX1 Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the OX1 Core daemon:
