...
In order to support loading of multiple wallets in ox1-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ox1.cpp.
...
Changes to ox1.cpp
----------------------
ox1.cpp is the entry point into ox1-qt, and as such, will require some minor modifications to provide hooks for
